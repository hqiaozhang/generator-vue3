...
module.exports = {
  ...
  dev: {
    ...
    proxyTable: {
      '/pm': {
        // target: 'http://weatherprod.waming-air.com:9010', // 硬件环境
        // target: 'http://weatherdev.waming-air.com:9010', // 开发环境
        // target: 'http://test.aitectcare.com:9010', // 测试环境
        target: 'http://192.168.3.2:11012', // 联调环境
        // target: 'http://10.10.10.33:9010',// 榆林正式环境
        // target: 'http://58.83.189.234:8086', // 榆林开发环境
